...
// MARK: - Medium Motivation Widget View
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                // Motivation text
                Text("\u{201C}" + entry.motivation.text + "\u{201D}")
                ...
                // Source attribution
                Text("\u{2014} " + entry.motivation.source)
...
private struct OrnamentLineMotivation: View {
    private let goldColor = Color(red: 0.831, green: 0.686, blue: 0.216)
