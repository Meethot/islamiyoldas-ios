...
public class DhikrWidgetProvider extends AppWidgetProvider {
    ...
    private static final String[][] PRESETS = {
        ...
        {"kelime_i_tevhid", "Kelime-i Tevhid", "لَا إِلٰهَ إِلَّا اللَّهُ مُحَمَّدٌ رَسُولُ اللَّهِ", "Allah'tan başka ilah yoktur, Muhammed O'nun elçisidir.", "100"},
        {"kelime_i_sehadet", "Kelime-i Şehadet", "أَشْهَدُ أَنْ لَا إِلٰهَ إِلَّا اللَّهُ", "Şahitlik ederim ki Allah'tan başka ilah yoktur.", "33"},
        {"besmele", "Besmele", "بِسْمِ اللَّهِ الرَّحْمٰنِ الرَّحِيمِ", "Rahman ve Rahim olan Allah'ın adıyla.", "100"},
        {"subhanallahi_ve_bihamdihi", "Sübhanallahi ve Bihamdihî", "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ", "Allah'ı hamd ile tesbih ederim.", "100"},
        {"subhanallahi_velazim", "Sübhanallahi ve Bihamdihî Sübhanallahil-Azîm", "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ سُبْحَانَ اللَّهِ الْعَظِيمِ", "Dile hafif, mizanda ağır iki cümle.", "100"},
        {"bakiyat_salihat", "Sübhanallahi velhamdülillahi", "سُبْحَانَ اللَّهِ وَالْحَمْدُ لِلَّهِ وَلَا إِلٰهَ إِلَّا اللَّهُ وَاللَّهُ أَكْبَرُ", "En kalıcı güzel ameller: tesbih, hamd, tevhid ve tekbir.", "100"},
        {"tevhid_zikri", "Lâ ilâhe illallahü vahdehû", "لَا إِلٰهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ", "Allah birdir, ortağı yoktur; O her şeye kadirdir.", "100"},
        {"seyyidul_istigfar", "Seyyidü'l-İstiğfar", "سَيِّدُ الِاسْتِغْفَارِ", "İstiğfar dualarının en üstünü.", "1"},
        {"hasbiyallah", "Hasbiyallahü lâ ilâhe illâ Hû", "حَسْبِيَ اللَّهُ لَا إِلٰهَ إِلَّا هُوَ", "Allah bana yeter; O'na tevekkül ettim.", "7"},
        {"allahumme_ecirni", "Allahümme Ecirnî", "اَللَّهُمَّ أَجِرْنِي مِنَ النَّارِ", "Allah'ım, beni cehennem ateşinden koru.", "7"},
        {"rabbena_atina", "Rabbenâ Âtinâ", "رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً", "Rabbimiz! Bize dünyada ve ahirette iyilik ver.", "10"},
        {"salaten_tuncina", "Salât-ı Münciye", "الصَّلَاةُ الْمُنْجِيَةُ", "Tüm tehlike ve sıkıntılardan kurtuluş için.", "100"},
        {"felak", "Felak Suresi", "سُورَةُ الْفَلَقِ", "Yarattıklarının şerrinden sabahın Rabbine sığınırım.", "100"},
        {"nas", "Nas Suresi", "سُورَةُ النَّاسِ", "İnsanların Rabbine, Melikine ve İlahına sığınırım.", "100"},
        {"subhane_rabbiyel_azim", "Sübhâne Rabbiyel-Azîm", "سُبْحَانَ رَبِّيَ الْعَظِيمِ", "Yüce Rabbimi tenzih ederim — rükû tesbihi.", "33"},
        {"subhane_rabbiyel_ala", "Sübhâne Rabbiyel-A'lâ", "سُبْحَانَ رَبِّيَ الْأَعْلَى", "En yüce Rabbimi tenzih ederim — secde tesbihi.", "33"},
        {"subbuhun_kuddusun", "Sübbûhun Kuddûsün", "سُبُّوحٌ قُدُّوسٌ", "Meleklerin ve Rûh'un Rabbi; münezzeh, mukaddestir.", "33"},
        {"rabbi_zidni_ilma", "Rabbi Zidnî İlmâ", "رَبِّ زِدْنِي عِلْمًا", "Rabbim, ilmimi artır.", "33"},
        {"rabbisrah_li_sadri", "Rabbi'şrah lî Sadrî", "رَبِّ اشْرَحْ لِي صَدْرِي", "Rabbim! Göğsümü genişlet, işimi kolaylaştır.", "33"},
        {"rabbena_la_tuzig", "Rabbenâ lâ Tüziğ Kulûbenâ", "رَبَّنَا لَا تُزِغْ قُلُوبَنَا", "Rabbimiz! Kalplerimizi kaydırma.", "10"},
        {"ya_hayyu_ya_kayyum", "Yâ Hayyu Yâ Kayyûm", "يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ", "Ey Hayy ve Kayyûm! Rahmetinle yardım diliyorum.", "100"},
        {"ya_erhamer_rahimin", "Yâ Erhamer-Râhimîn", "يَا أَرْحَمَ الرَّاحِمِينَ", "Ey merhametlilerin en merhametlisi!", "100"},
        {"melikul_hakkul_mubin", "Lâ ilâhe illallahü'l-Melikü'l-Hakk", "لَا إِلٰهَ إِلَّا اللَّهُ الْمَلِكُ الْحَقُّ الْمُبِينُ", "Apaçık hak ve mülkün sahibi olan Allah.", "100"},
        {"estagfirullah_elazim", "Estağfirullahe'l-Azîm", "أَسْتَغْفِرُ اللَّهَ الْعَظِيمَ وَأَتُوبُ إِلَيْهِ", "Yüce Allah'tan bağışlanma diler, O'na tövbe ederim.", "100"},
        {"afv_afiyet", "Allahümme es'elüke'l-Afve ve'l-Âfiye", "اَللَّهُمَّ إِنِّي أَسْأَلُكَ الْعَفْوَ وَالْعَافِيَةَ", "Allah'ım! Senden af ve âfiyet dilerim.", "100"},
        {"bismillahillezi", "Bismillâhillezî lâ Yedurru", "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ", "O'nun adıyla hiçbir şey zarar veremez.", "3"},
        {"euzu_bikelimatillah", "Eûzü bi-Kelimâtillâh", "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ", "Allah'ın eksiksiz kelimelerine sığınırım.", "3"},
        {"radiytu_billahi", "Radîtü Billâhi Rabbâ", "رَضِيتُ بِاللَّهِ رَبًّا", "Rab olarak Allah'tan razıyım.", "3"},
        {"adede_halkihi", "Sübhânallâhi Adede Halkıhî", "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ عَدَدَ خَلْقِهِ", "Yarattıkları sayısınca Allah'ı tesbih ederim.", "3"},
        {"salat_i_fetih", "Salât-ı Fetih", "صَلَاةُ الْفَاتِحِ", "Maddî ve manevî fetihler için okunan salavat.", "100"},
        {"allahumme_entes_selam", "Allahümme Ente's-Selâm", "اَللَّهُمَّ أَنْتَ السَّلَامُ وَمِنْكَ السَّلَامُ", "Allah'ım! Sen Selâm'sın, selâmet Sendendir.", "1"},
    };
