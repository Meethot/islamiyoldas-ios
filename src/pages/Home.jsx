...
const ESMA_UL_HUSNA = [
    { name: 'Er-Rahman', meaning: 'Herkesi ve herşeyi kuşatan sınırsız merhamet sahibi.', meaning_en: 'The Most Merciful, whose boundless mercy encompasses all.', meaning_de: 'Der Allerbarmer, der allen Geschöpfen in dieser Welt barmherzig ist.', meaning_ru: 'Милостивый ко всем творениям в этом мире.', ebced: 298, virtue: 'Dünya ve ahiret mutluluğu, rızık bolluğu için okunur.', virtue_en: 'For worldly and eternal happiness, abundance of sustenance.', virtue_de: 'Für Glückseligkeit im Diesseits und Jenseits, Fülle der Versorgung.', virtue_ru: 'Для счастья в этом мире и в вечной жизни, изобилия удела.', calligraphy: 'الرَّحْمَنُ' },
    { name: 'Er-Rahim', meaning: 'Kendisine inananlara özel merhameti olan.', meaning_en: 'The Especially Merciful to believers.', meaning_de: 'Der besonders Barmherzige zu den Gläubigen im Jenseits.', meaning_ru: 'Особо Милосердный к верующим в День Суда.', ebced: 258, virtue: 'Maddi ve manevi rızık, hidayet ve şefkat için okunur.', virtue_en: 'For material and spiritual sustenance, guidance and compassion.', virtue_de: 'Für materielle und geistliche Versorgung, Rechtleitung und Mitgefühl.', virtue_ru: 'Для материального и духовного удела, наставления и сострадания.', calligraphy: 'الرَّحِيمُ' },
    { name: 'El-Melik', meaning: 'Bütün kainatın mutlak sahibi ve hükümdarı.', meaning_en: 'The absolute Sovereign and Owner of all creation.', meaning_de: 'Der absolute Herrscher und Eigentümer der gesamten Schöpfung.', meaning_ru: 'Абсолютный Властелин и Хозяин всего творения.', ebced: 90, virtue: 'Maddi ve manevi güç, itibar ve söz sahibi olmak için okunur.', virtue_en: 'For material and spiritual power, prestige and authority.', virtue_de: 'Für materielle und geistliche Kraft, Ansehen und Autorität.', virtue_ru: 'Для материальной и духовной силы, почёта и авторитета.', calligraphy: 'الْمَلِكُ' },
    { name: 'El-Kuddüs', meaning: 'Bütün eksikliklerden münezzeh, mukaddes.', meaning_en: 'The Most Holy, free from all imperfections.', meaning_de: 'Der Allheilige, frei von jeglicher Unvollkommenheit.', meaning_ru: 'Пресвятой, свободный от всех недостатков.', ebced: 170, virtue: 'Manevi temizlik, kalbin nurlanması ve korkulardan emin olmak için.', virtue_en: 'For spiritual purification, enlightenment of the heart and safety from fears.', virtue_de: 'Für geistliche Reinigung und Erleuchtung des Herzens.', virtue_ru: 'Для духовного очищения и озарения сердца.', calligraphy: 'الْقُدُّوسُ' },
    { name: 'Es-Selam', meaning: 'Esenlik veren, selamete çıkaran.', meaning_en: 'The Source of Peace, who delivers to safety.', meaning_de: 'Die Quelle des Friedens, der Seine Diener in Sicherheit bringt.', meaning_ru: 'Источник мира, дарующий безопасность Своим рабам.', ebced: 131, virtue: 'Huzur, barış ve selamete ermek, hastalıklardan şifa bulmak için.', virtue_en: 'For peace, tranquility, safety and healing from illnesses.', virtue_de: 'Für Frieden, Ruhe und Erreichen der Sicherheit.', virtue_ru: 'Для покоя, умиротворения и обретения безопасности.', calligraphy: 'السَّلَامُ' },
];
