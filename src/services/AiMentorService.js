...
ÇIKTI FORMATI (JSON):
{
  ...
  "recommendedZikr": {
    ...
    "count": "Esma'nın ebced değeri veya uygun sayı (aşağıdaki tabloya bak)"
  },
  "quranRef": {
...
const PROMPT_MAP = { tr: SYSTEM_PROMPT_TR, en: SYSTEM_PROMPT_EN, de: SYSTEM_PROMPT_DE, ru: SYSTEM_PROMPT_RU, ar: SYSTEM_PROMPT_AR, az: SYSTEM_PROMPT_AZ };
