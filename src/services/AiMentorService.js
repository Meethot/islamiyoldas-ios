...
ФОРМАТ ВЫВОДА (JSON):
{
  ...
  "recommendedZikr": {
    "name": "Рекомендуемое имя Асма аль-Хусна (например: Аль-Гани, Ар-Раззак, Аль-Вадуд) или общий зикр (например: СубханАллах, АстагфируЛлах). Предпочтительно выбирай из 99 Имён Аллаха.",
    "meaning": "Краткое значение зикра",
    "count": 33
  },
  "quranRef": {
    "surah": "Номер суры (1-114, выбери суру, ПОДХОДЯЩУЮ к ситуации пользователя)",
    "verse": "Номер аята (выбери аят, несущий исцеление проблеме пользователя)",
    "reason": "Краткое пояснение, почему ты выбрал этот аят."
  }
}

ВАЖНО: Для quranRef КАЖДЫЙ РАЗ выбирай РАЗНЫЙ и ЗНАЧИМЫЙ аят в зависимости от ситуации пользователя!
Примеры:
...
const PROMPT_MAP = { tr: SYSTEM_PROMPT_TR, en: SYSTEM_PROMPT_EN, de: SYSTEM_PROMPT_DE, ru: SYSTEM_PROMPT_RU };
